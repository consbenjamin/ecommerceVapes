    ...
    <div class="container mx-auto px-4">
        ...
        <ol class="flex items-center">
          ...
          <li class="text-left">
            <div class="flex items-center">
              <span class="mx-2 text-gray-400">/</span>
              <div class="-m-1">
                <a href="#" class="rounded-md p-1 text-sm font-medium text-gray-600 focus:text-gray-900 focus:shadow hover:text-gray-800" aria-current="page"> Vapes </a>
              </div>
            </div>
          </li>
        </ol>
      ...
      <div class="lg:col-gap-12 xl:col-gap-16 mt-8 grid grid-cols-1 gap-12 lg:mt-12 lg:grid-cols-5 lg:gap-16">
          ...
          <div class="lg:flex lg:items-start">
            <div class="lg:order-2 lg:ml-5">
              <div class="max-w-xl overflow-hidden rounded-lg">
                <img class="h-full w-full max-w-full object-cover" src={product.img} alt="" />
              </div>
            </div>
            ...
            <div class="mt-2 w-full lg:order-1 lg:w-32 lg:flex-shrink-0">
              <div class="flex flex-row items-start lg:flex-col">
                <button type="button" class="flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 border-gray-900 text-center">
                  <img class="h-full w-full object-cover" src={product.img} alt="" />
                </button>
        ...
        <div class="lg:col-span-2 lg:row-span-2 lg:row-end-2">
          ...
          <h2 class="mt-8 text-base text-gray-900">Flavors</h2>
          <div class="mt-3 flex select-none flex-wrap items-center gap-1">
            <label class="">
              <input type="radio" name="type" value="Powder" class="peer sr-only" />
              <p class="peer-checked:bg-black peer-checked:text-white rounded-lg border border-black px-6 py-2 font-bold">{product.flavor}</p>
            </label>
            <label class="">
...
{/* <div className="flex justify-center mt-[200px]">
        <div className="p-4 bg-white rounded-xl shadow-xl hover:shadow-2xl hover:scale-[1.03] transition-all transform duration-500 ">
          <img className="bg-cover" src={product.img} alt="imgNotFound" />
          <div>
            <h1 className="text-xl font-bold text-gray-700 lg:text-2xl">{product.name}</h1>
            <div className='pt-2'>
              <p className='text-lg capitalize font-medium text-gray-400'>{product.flavor}</p>
            </div>
            <div className="my-1">
              <button className="block text-xl font-semibold text-gray-700 cursor-auto">${product.price}</button>
            </div>
            <div className='flex justify-center items-center'>
            <button className='text-lg block bg-primary font-semibold hover:text-black text-white rounded-lg shadow w-full py-2'>Agregar al carro</button>
            </div>
          </div>
        </div>
      </div> */}
